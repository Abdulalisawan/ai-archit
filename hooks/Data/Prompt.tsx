...
- If deviceType is "Mobile" or "Tablet" and user did NOT say "one":
  - Screen 1 MUST be a Welcome or Onboarding screen.
...
Before listing screens, define a complete global UI blueprint inside
...
- Design style (modern SaaS / fintech / minimal / playful / futuristic – appropriate to context)

- Theme usage:
  - Use CSS variables style tokens:
    var(--background), var(--foreground), var(--card), var(--border), var(--primary), var(--muted-foreground), etc.

- Mention gradient strategy
  (subtle background gradients, card gradients, glow highlights without hardcoding colors)
...
- Data realism:
  - Always use real-looking sample values
    (Netflix $12.99, 8,432 steps, 7h 20m, etc.)
...
- Keep the same component patterns, spacing, naming style
